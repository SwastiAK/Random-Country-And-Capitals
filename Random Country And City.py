# -*- coding: utf-8 -*-
"""
Created on Tue Jun  7 13:05:07 2022
...
btn = Button(root, text = "Display Country And City Name", command = country_city_list, bg="blue")
...
btn2 = Button(root, text = "Display Country And City Name Randomly", command = random_country_city, bg="blue")
